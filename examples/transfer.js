...
let pKeyActive = PrivateKey.fromWif(
    "5KBuq5WmHvgePmB7w3onYsqLM8ESomM2Ae7SigYuuwg8MDHW7NN"
); // Replace with your own Active Private Key
let pKeyMemo = PrivateKey.fromWif(
    "5KBuq5WmHvgePmB7w3onYsqLM8ESomM2Ae7SigYuuwg8MDHW7NN"
); // Replace with your own Memo Private Key
    ...
    ChainStore.init(nobroadcast).then(() => {
        ...
        Promise.all([
            ...
            tr.set_required_fees().then(() => {
                tr.add_signer(
                    pKeyActive,
                    pKeyActive.toPublicKey().toPublicKeyString()
                );
